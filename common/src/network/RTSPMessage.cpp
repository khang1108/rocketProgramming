...
RTSPMessage::Request RTSPMessage::parseRequest(const std::string& message) {
    Request req;
...
RTSPMessage::Response RTSPMessage::parseResponse(const std::string& message) {
    Response res;
    std::vector<std::string> lines = split(message, '\n');
...
std::string RTSPMessage::buildRequest(const std::string& method, const std::string url, int cseq,
...
std::string RTSPMessage::buildResponse(int statusCode, std::string reason, int cseq,
                                       const std::map<std::string, std::string>& headers) {
    std::stringstream ss;
...
std::string RTSPMessage::getHeader(const std::map<std::string, std::string>& headers,
...
std::string RTSPMessage::statusCodeToReason(int statusCode) {
    switch (statusCode) {
        case 200:
            return "OK";
        case 400:
